...
class Noticiaerror extends CI_Controller {
	...
	public function index()
	{
		...
		if(empty($idnoti) || empty($urlamigable)){
			redirect('noticias');
		}
		...
		$data['noticiamn'] = $this->model_portal->getNoticiaError($idnoti);
		#Cargo a los Especialistas
		$data['especialistas'] = $this->model_portal->getEspecialistas();
		$this->load->view('noticiaerror', $data);
	}
