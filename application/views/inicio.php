...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
	...
	<script type="text/javascript">
		$(function(){
			$("#search").autocomplete({
				source: "buscarnoticia/index"//, // path to the get_birds method
				//select: function( event, data ) {
				//	console.log(data);
				//}
			}).data( "ui-autocomplete" )._renderItem = function( ul, item ) {
        var inner_html = '<a><div class="list_item_container"><div class="image"><img src="' + item.image + '"></div><div class="label">' + item.label + '</div><div class="description">' + item.fecha + '</div></div></a>';
        return $( "<li></li>" )
