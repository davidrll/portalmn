...
<head>
	<meta charset="utf-8">
	<title>RESULTADO DE LA BUSQUEDA - MERCADO NEGRO TV</title>
...
<div class="slide_likebox">
	...
	<header>
		...
		<div id="ads-cabecera" class="hidden-phone">
			...
			<!--<a href="http://www.somosfiap.pe"><img src="<?php echo base_url(); ?>New/Images/banner somos fiap.png"/></a>
			
			<object width="728" height="90">
				<param name="movie" value="http://cludmn.net/ads/ads-campGrande.swf" />
				<param name="play" value="true" > 
				<embed src="http://cludmn.net/ads/ads-campGrande.swf" />
				</embed>
			</object>-->
			<object width="728" height="90">
			...
			<div id="navegacion">
				...
				<?php }
					...
					foreach ($importante1 as $impor) {
						$urlBloque1 = buscar::utf8($impor->nombres);
						$urlBloque1 = buscar::urlamigable($urlBloque1);
						if(strlen($impor->bio) > 249){
							$impor->bio = trim(utf8_encode($impor->bio)).'...';
						}
						$urlEspecialista = buscar::urlamigable(utf8_encode($impor->nombres));
							#Controlo que el Cargo no sea muy extenso
							
							$urlNota = buscar::urlamigable(utf8_encode($impor->frase));
					?>
					<div id="importante" class="visible-desktop">
				...
				<?php }
						...
						foreach ($importante2 as $noticia) {
							$urlBloque1 = buscar::utf8($noticia->titulo);
							$urlBloque1 = buscar::urlamigable($urlBloque1);
					?>
					<div id="importante" class="visible-desktop separador">
		...
		<div class="row-fluid">
			<div class="span8">
				...
				<div id="mininoticia"> 
					...
					<!-- COMPARTIR END -->
					<div class="feregistro"><span class="catpubli"><?php echo $noticia->subida; ?></span> <span class="fechanoti"><?php echo $noticia->fecha; ?></span></div>
					<h1><a href="<?php echo base_url().'noticia/'.$noticia->codigo.'/'.$urlBloque1;?>"><?php echo utf8_encode($noticia->titulo); ?></a></h1>
					<span class="exnoticia"><?php echo strip_tags(utf8_encode($noticia->extracto)); ?>...</span>
				</div>
				<?php
						} 
					}
				...
				<?php
					...
					if(is_array($btl)){
						foreach ($btl as $noticia1) {
				?>
				<div id="mininoticia"> 
					<img src="<?php echo $noticia1->sumilla_g;?>" class="fonoticia" />
					<!-- COMPARTIR BEGIN -->
					...
					<script type="text/javascript" src="<?php echo base_url().'assets/js/share.js'?>"></script>
					<!-- COMPARTIR END -->
					<div class="feregistro"> <span class="catpieza">GALERÍA PUBLICITARIA - BTL</span><span class="fechanoti"><?php echo $noticia1->fecha; ?></span></div>
					<h1><?php echo  utf8_encode($noticia1->titulo); ?></h1>
					<span class="exnoticia"><?php echo trim(utf8_encode(strip_tags($noticia1->contenido).$noticia1->campania.$noticia1->cliente)); ?></span>
				</div>
				<?php
						} 
					}
				...
				<?php
					...
					if(is_array($radio)){
						foreach ($radio as $noticia2) {
				?>
				<div id="mininoticia"> 
					<img src="<?php echo $noticia2->imagen;?>" class="fonoticia" />
					<!-- COMPARTIR BEGIN -->
					<a class="a2a_dd" href="http://www.addtoany.com/share_save?linkurl=<?php echo "http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?>&amp;linkname="><img src="<?php echo base_url(); ?>assets/img/share.png" width="20" class="shared" alt="compartir"></a>
					<script type="text/javascript">
						var a2a_config = a2a_config || {};
					...
					<script type="text/javascript" src="<?php echo base_url().'assets/js/share.js'?>"></script>
					<!-- COMPARTIR END -->
					<div class="feregistro"> <span class="catpieza">GALERÍA PUBLICITARIA - RADIO</span><span class="fechanoti"><?php echo $noticia2->fecha; ?></span></div>
					<h1><?php echo  utf8_encode($noticia2->titulo); ?></h1>
					<span class="exnoticia"><?php echo trim(utf8_encode(strip_tags($noticia2->contenido).$noticia2->campania.$noticia2->cliente)); ?></span>
				</div>
				<?php
						} 
					}
				...
				<?php
					...
					if(is_array($interactivo)){
						foreach ($interactivo as $noticia3) {
				?>
				<div id="mininoticia"> 
					<img src="<?php echo $noticia3->sumilla_g;?>" class="fonoticia" />
					<!-- COMPARTIR BEGIN -->
					<a class="a2a_dd" href="http://www.addtoany.com/share_save?linkurl=<?php echo "http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?>&amp;linkname="><img src="<?php echo base_url(); ?>assets/img/share.png" width="20" class="shared" alt="compartir"></a>
					<script type="text/javascript">
						var a2a_config = a2a_config || {};
					...
					<script type="text/javascript" src="<?php echo base_url().'assets/js/share.js'?>"></script>
					<!-- COMPARTIR END -->
					<div class="feregistro"> <span class="catpieza">GALERÍA PUBLICITARIA - INTERACTIVO</span><span class="fechanoti"><?php echo $noticia3->fecha; ?></span></div>
					<h1><?php echo  utf8_encode($noticia3->titulo); ?></h1>
					<span class="exnoticia"><?php echo trim(utf8_encode(strip_tags($noticia3->contenido).$noticia3->campania.$noticia3->cliente)); ?></span>
				</div>
				<?php
						} 
					}
				...
				<?php
					...
					if(is_array($grafica)){
						foreach ($grafica as $noticia4) {
				?>
				<div id="mininoticia"> 
					<img src="<?php echo $noticia4->sumilla_g;?>" class="fonoticia" />
					<!-- COMPARTIR BEGIN -->
					<a class="a2a_dd" href="http://www.addtoany.com/share_save?linkurl=<?php echo "http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?>&amp;linkname="><img src="<?php echo base_url(); ?>assets/img/share.png" width="20" class="shared" alt="compartir"></a>
					<script type="text/javascript">
						var a2a_config = a2a_config || {};
					...
					<script type="text/javascript" src="<?php echo base_url().'assets/js/share.js'?>"></script>
					<!-- COMPARTIR END -->
					<div class="feregistro"> <span class="catpieza">GALERÍA PUBLICITARIA - GRÁFICA</span><span class="fechanoti"><?php echo $noticia4->fecha; ?></span></div>
					<h1><?php echo  utf8_encode($noticia4->titulo); ?></h1>
					<?php
						if(!empty($noticia4->audio)){
					?>
					<audio src="http://mercadonegro.pe/New/Audio/<?php echo $noticia4->audio; ?>" preload="auto" />
					<?php } ?>
					<span class="exnoticia"><?php echo trim(utf8_encode(strip_tags($noticia4->contenido).$noticia4->campania.$noticia4->cliente)); ?></span>
				</div>
				<?php
						} 
					}
				?>
				<?php
					if(is_array($comerciales_tv)){
						foreach ($comerciales_tv as $noticia5) {
				?>
				<div id="mininoticia"> 
					<img src="<?php echo $noticia5->imagen;?>" class="fonoticia" />
					<!-- COMPARTIR BEGIN -->
					<a class="a2a_dd" href="http://www.addtoany.com/share_save?linkurl=<?php echo "http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?>&amp;linkname="><img src="<?php echo base_url(); ?>assets/img/share.png" width="20" class="shared" alt="compartir"></a>
					<script type="text/javascript">
						var a2a_config = a2a_config || {};
					...
					<script type="text/javascript" src="<?php echo base_url().'assets/js/share.js'?>"></script>
					<!-- COMPARTIR END -->
					<div class="feregistro"> <span class="catpieza">GALERÍA PUBLICITARIA - MERCADONEGRO TV</span><span class="fechanoti"><?php echo $noticia5->fecha; ?></span></div>
					<h1><?php echo  utf8_encode($noticia5->titulo); ?></h1>
					<?php
						if(!empty($noticia5->audio)){
					?>
					<audio src="http://mercadonegro.pe/New/Audio/<?php echo $noticia5->audio; ?>" preload="auto" />
					<?php } ?>
					<span class="exnoticia"><?php echo trim(utf8_encode(strip_tags($noticia5->contenido).$noticia5->campania.$noticia5->cliente)); ?></span>
				</div>
				<?php
						} 
					}
				?>
				<?php 
					if(is_array($portal_video)){
						foreach ($portal_video as $video) {
				?>
				<div id="mininoticia"> 
					<img src="<?php echo base_url(); ?>assets/img/share.png" width="20" class="shared">
					<div class="feregistro"><span class="catmntv">MERCADONEGRO TV</span> <span class="fechanoti"><?php echo $video->fecharegistro; ?></span></div>
					<h1><?php echo $video->titulo; ?></h1>
					<div class="videoWrapper">
					    <!-- Copy & Pasted from YouTube -->
					    <iframe width="560" height="349" src="http://www.youtube.com/embed/<?php echo $video->codyoutube; ?>?rel=0&hd=1" frameborder="0" allowfullscreen></iframe>
					</div>
				</div>
				<?php
						} 
						...
						if(is_array($especialistas)){
							foreach ($especialistas as $especialista) {
								...
								if(strlen($especialista->cargo) > 55){
									$especialista->cargo = utf8_encode(substr($especialista->cargo, 0, 55)).'...';
								}else{
									$especialista->cargo = utf8_encode($especialista->cargo);
								}
							...
							<?php 
								if(!empty($especialista->titulocolum) && !empty($especialista->desc_colum)){
									...
									if(strlen($especialista->titulocolum) > 30){
										$especialista->titulocolum = utf8_encode(substr($especialista->titulocolum, 0, 30)).'...';
									}else{
										$especialista->titulocolum = utf8_encode($especialista->titulocolum);
									}

									if(strlen($especialista->desc_colum) > 150){
										$especialista->desc_colum = utf8_encode(substr($especialista->desc_colum, 0, 150)).'...';
									}else{
										$especialista->desc_colum = utf8_encode($especialista->desc_colum);
									}
							?>
