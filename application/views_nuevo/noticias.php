...
<head>
	<meta charset="utf-8">
	<title>NOTICIAS - MERCADO NEGRO TV</title>
			...
			<div id="navegacion">
				...
				<div id="importante" class="visible-desktop">
					<a href="http://mercadonegro.pe/nota/250/neuromarketing-publicidad-y-percepcin-del-consumidor" target="_blank">
						...
						<img src="jorge_a8cce2.jpg" width="100" height="100" alt="fw" title=""/>
					</a>
				</div>
				<div id="importante" class="visible-desktop separador">
					<a href="http://mercadonegro.pe/noticia/3890/libro-recomendado-no-tengo-plata-para-mi-pelcula" target="_blank">
						...
						<img src="libro_neo.jpg" width="100" height="100" alt="fs" title="" />
					</a>
				</div>-->
				<?php 
		...
		<div class="row-fluid">
			<div class="span8">
				...
				<div id="mininoticia" class="message_box" data-id="<?php echo $noticia->codigo;?>"> 
					<a href="<?php echo base_url().'noticia/'.$noticia->codigo.'/'.$urlBloque1;?>"><img src="<?php echo $noticia->portada;?>" class="fonoticia" /></a>
					<!-- COMPARTIR BEGIN -->
			...
			<div class="span4">
				...
				<div class="adslarge hidden-phone">
					...
					<!--<object width="305">
						<param name="movie" value="<?php echo base_url(); ?>CRS_animacion.swf" >
						<param name="play" value="true" > 
						<embed src="<?php echo base_url(); ?>CRS_animacion.swf" >
						</embed>
					</object>
					<object width="305">
						<param name="movie" value="<?php echo base_url(); ?>backstage_back.swf" >
						<param name="play" value="true" > 
						<embed src="<?php echo base_url(); ?>backstage_back.swf" >
						</embed>
					</object>-->
					<object width="305">
						<param name="movie" value="<?php echo base_url(); ?>zbook.swf" >
						<param name="play" value="true" > 
						<embed src="<?php echo base_url(); ?>zbook.swf" >
						</embed>
					</object>
				</div>
