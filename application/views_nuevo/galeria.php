		...
		<div class="row-fluid">
			<div class="span8">
				...
				<article id="mercadonegrotv">
					...
					<!-- COMPARTIR END -->
					<div class="feregistro"> <span class="catpieza">GALERÍA PUBLICITARIA</span><span class="fechanoti"><?php echo $noticia->fecha; ?></span></div>
					<h1><?php echo  $noticia->titulo; ?></h1>
					<?php
						if(!empty($noticia->audio)){
					?>
					<audio src="http://mercadonegro.pe/New/Audio/<?php echo $noticia->audio; ?>" preload="auto" />
					<?php } ?>
					<span class="exnoticia"><?php echo trim($noticia->contenido.$noticia->campania.$noticia->cliente); ?></span>
				...
				<article id="mercadonegrotv" class="hidden-phone">
					<h1>MÁS DE MERCADONEGRO GALERÍA</h1>
				</article>
				<section id="masgaleriavideos" class="hidden-phone">
					...
					?>
					<div id="masyoutube">
						<div class="categoria"><?php echo $categoria; ?></div><a href="<?php echo base_url().'galeria/'.$galeria1->items.'/'.$galeria1->codigo.'/'.$urlGaleria; ?>" ></a>
						<img src="<?php echo $galeria1->imagen; ?>" />
						<div class="detailvideo"><a href="<?php echo base_url().'galeria/'.$galeria1->items.'/'.$galeria1->codigo.'/'.$urlGaleria; ?>"><?php echo $galeria1->titulo; ?></a> </div>
					</div>
					<?php 
						} 
					?>
